...
legend([h1, h2, h3, h4], 'LRR (LoG)', 'LRR (Sobel)', 'MLAP', 'LRCRL (Ours)', 'Location','southwest')
...
print(gcf, '-depsc2', 'face_mean.eps');
...
print(gcf, '-depsc2', 'face_median.eps');
...
print(gcf, '-depsc2', 'face_diff.eps');
