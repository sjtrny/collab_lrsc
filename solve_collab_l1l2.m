function [ Zs ] = solve_collab_l1l2( Xs, lambda, tau )
%SOLVE_COLLAB Summary of this function goes here
...
for t = 1 : max_iterations
    ...
    func_vals(t) = sub_func_val + tau*norm_l1l2(A');
