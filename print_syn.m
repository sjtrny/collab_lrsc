...
print(gcf, '-depsc2', 'synthetic_mean.eps');
...
print(gcf, '-depsc2', 'synthetic_median.eps');
...
print(gcf, '-depsc2', 'synthetic_min.eps');
...
print(gcf, '-depsc2', 'synthetic_max.eps');
...
print(gcf, '-depsc2', 'synthetic_std.eps');
...
print(gcf, '-depsc2', 'synthetic_diff.eps');
